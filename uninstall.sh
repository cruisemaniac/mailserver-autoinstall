...
command -v mysql > /dev/null 2>&1 || { checkBin mysqladmin >&2; exit 1; }
...
read -rp "Appuyez sur [ENTRÉE] pour continuer ou faites CTRL+C pour annuler"
...
read -rp "VOULEZ-VOUS VRAIMENT CONTINUER ? [Tapez OUI pour continuer] : " IMA_FIRIN_MAH_LAZOR
